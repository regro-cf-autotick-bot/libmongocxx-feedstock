...
pixi add libmongocxx
# for installing globally
pixi global install libmongocxx
```
...
It is possible to list all of the versions of `libmongocxx` available on your platform:
...
```
pixi search libmongocxx --channel conda-forge
```
